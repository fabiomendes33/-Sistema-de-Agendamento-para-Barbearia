...
function SuccessScreen({ form, servico, barbeiro, onNew }: { 
  ...
  const telefone = (process.env.NEXT_PUBLIC_TELEFONE_BARBEARIA || '34999605820').replace(/\D/g, '')
  const nomeBarbearia = process.env.NEXT_PUBLIC_NOME_BARBEARIA || 'Barbearia Dom'
  const dataFormatada = form.data ? format(form.data, "dd/MM/yyyy", { locale: ptBR }) : ''

  const mensagemWhatsApp = encodeURIComponent(
    `Olá! Acabei de fazer um agendamento pelo site da ${nomeBarbearia}:\n\n` +
  ...
  return (
    <div className="min-h-screen bg-barber-black bg-texture flex flex-col items-center justify-center p-6">
      <div className="max-w-md w-full text-center">
        ...
        <div className="card-dark rounded-2xl p-6 text-left space-y-3 mb-6 animate-fade-up animate-delay-300" style={{animationFillMode:'forwards'}}>
        ...
        <p className="text-xs text-gray-600 mb-4 animate-fade-up animate-delay-500" style={{animationFillMode:'forwards'}}>
